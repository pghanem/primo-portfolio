...
const AboutSection = (): React.ReactElement => {
    return <div css={styles.aboutContainer}>
        <p>I'm a developer passionate about crafting intuitive, timeless user interfaces that combine thoughtful system design with solid engineering. My favorite work is at the intersection of design and development, where I create seamless experiences that are both visually appealing and easy to maintain.</p>
        <p>Currently, I’m a UI Developer at Jostle, where I specialize in core feature rebuilds and modernization. I lead the planning, creation, and maintenance of UI components that power Jostle’s frontend, including key elements like the Search interface and the system-wide Collections interface — our unified approach to managing and displaying list-type data.</p>
