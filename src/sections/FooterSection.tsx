...
const FooterSection = (): React.ReactElement => {
    ...
    return (
        <div css={styles.footerContainer}>
            ...
            <div
                onClick={() => handleClick("https://www.jetbrains.com/idea/")}
            ...
            <div
                onClick={() => handleClick("https://react.dev/")}
                css={styles.clickable}
            >
                React
            </div>{" "}and{" "}
            <div
                onClick={() => handleClick("https://emotion.sh/")}
                css={styles.clickable}
            >
                Emotion CSS
            </div>
            ...
            <div
                onClick={() => handleClick("https://rsms.me/inter/")}
                css={styles.clickable}
            >
                Inter
            </div>{" "}
